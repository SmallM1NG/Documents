...
## 来源
- database.xml 格式: https://cn.virtualdj.com/wiki/VDJ_database.html (2026-06-29)
- 注册表与目录结构: 用户提供 (2026-06-29)
- 列表文件格式: 实际读取用户数据目录文件分析 (2026-06-29)
...
```
History/
├── 2026-06-29.m3u       ← 最新一段时间的历史(根目录直接存放)
├── 2026-06-28.m3u
